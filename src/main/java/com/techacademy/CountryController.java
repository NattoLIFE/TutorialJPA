...
public class CountryController {
 ...
 // ----- 詳細画面 -----
    ...
    public String getCountryDetail(@PathVariable("code") String code, Model model) {
        // 指定された国の詳細情報？
    ...
    public String getDeleteCountryForm(@PathVariable("code") String code, Model model) {
        // 削除対象の国の情報を取得してフォームに表示
        Country country = service.getCountry(code);
        model.addAttribute("country", country);
